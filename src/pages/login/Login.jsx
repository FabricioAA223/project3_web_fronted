...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      login(data.access_token); // Llamada al contexto para actualizar el estado de autenticación
      navigate('/dashboard');
    } catch (err) {
      setErrors({ general: 'Credenciales inválidas. Por favor, intenta de nuevo.' });
    } finally {
      setIsLoading(false);
    }
  };
